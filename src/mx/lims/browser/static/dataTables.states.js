/*! Review States for DataTables 1.2.3
 * ©2017 Menglan Technologies  Ltd - datatables.net/license
 */
...
var States = function( dt, config )
{
	...
	this.c = $.extend( true, {}, States.defaults, config );
