...
#
#  $ bin/test -s mx.lims -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src mx.lims.testing.MX_LIMS_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/mx/lims/tests/robot/test_example.robot
#
